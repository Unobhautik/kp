  ...
  return (
    <>
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="max-w-3xl bg-white p-0 rounded-2xl overflow-hidden max-h-[90vh] flex flex-col">
          <div className="grid md:grid-cols-2 h-full overflow-y-auto">
            {/* Product Image - Fixed position on top for mobile */}
            <div className="relative h-60 md:h-full bg-honey-50 md:sticky md:top-0">
              <img
                src={product.imageUrl}
                alt={product.name}
            ...
            {/* Product Details - Now scrollable */}
            <div className="p-6 flex flex-col overflow-y-auto">
              ...
              <div className="mt-6 space-y-3 sticky bottom-0 bg-white py-4">
                <a
                  href={product.amazonUrl}
                  target="_blank"
                  rel="noopener noreferrer"
