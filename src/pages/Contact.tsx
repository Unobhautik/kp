...
const Contact: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const publicKey = '1FCjUfQ2-YnVQwwWv';
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const serviceId = 'service_0zns6xm';
    const templateId = 'template_nb003ye';
    const publicKey = '1FCjUfQ2-YnVQwwWv';
    ...
    emailjs.sendForm(serviceId, templateId, form.current, publicKey)
      ...
      .catch((error) => {
        ...
        setIsSubmitting(false);
        setFormStatus('error');
        setErrorMessage(error.text || 'There was an error sending your message. Please try again.');
      });
  };
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-honey-100 p-8 md:p-10">
                ...
                <form ref={form} onSubmit={handleSubmit} className="space-y-6">
                  {/* Include hidden field for template_params if needed by EmailJS */}
                  ...
                  <button
                    ...
                    className={`${
                      isSubmitting ? 'bg-honey-400' : 'bg-honey-500 hover:bg-honey-600'
                    } text-white px-6 py-3 rounded-lg font-medium transition-colors shadow-md flex items-center justify-center gap-2 w-full sm:w-auto`}
                  >
